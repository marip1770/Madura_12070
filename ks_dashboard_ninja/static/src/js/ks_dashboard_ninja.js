        ...
        renderKpi: function(item, grid) {
            ...
            if (field.ks_data_formatting == 'exact'){
                if (field.ks_record_count){
                    ...
                    item_info['target'] = kpi_data[0].target;
                }
            }else{
                 if (field.ks_data_formatting == 'indian'){
                     item_info['count_1'] = self.ksNumIndianFormatter(kpi_data[0]['record_data'], 1);
                     item_info['target'] = self.ksNumIndianFormatter(kpi_data[0].target, 1);
                 }else{
                    item_info['target'] = self.ksNumFormatter(kpi_data[0].target, 1);
                     }
                 }
